export default {
  ...
  version: {
    ...
    workflowDispatched: 'Build Triggered',
    workflowDispatchedHint:
      'GitHub Actions is building the Docker image. The container updater will apply it after the image is ready.',
