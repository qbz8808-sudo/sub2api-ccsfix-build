        ...
        >
          ...
          <div class="p-4">
            ...
            <template v-else>
              ...
              <!-- Priority 2.5: Update workflow dispatched -->
                ...
                >
                  ...
                  <div class="min-w-0 flex-1">
                    ...
                    <p class="text-xs text-green-600/70 dark:text-green-400/70">
                      {{
                        workflowDispatched
                          ? t('version.workflowDispatchedHint')
                          : updateMessage || t('version.workflowDispatchedHint')
                      }}
                    </p>
                  </div>
                </div>
...
const workflowDispatched = ref(false)
...
async function refreshVersion(force = true) {
  ...
  updateMessage.value = ''
  workflowDispatched.value = false
...
async function handleUpdate() {
  ...
  try {
    ...
    workflowDispatched.value = Boolean(result.workflow_dispatched)
